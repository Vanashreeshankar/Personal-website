...
export default function Chatbot({ setShowContact }) {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch("https://personal-website-three-omega-48.vercel.app/chat", {
        method: "POST",
  ...
  const handleAction = (action) => {
    ...
    if (action === "resume") {
      window.open(
        "https://drive.google.com/file/d/1Pjh_bVxS2jFO2mIF7j5lYQd_z8Iva4S0/view?usp=sharing"
      );
    }
