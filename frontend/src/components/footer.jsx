...
export default function Footer() {
  return (
    <footer className="relative bg-black px-4 sm:px-6 md:px-16 py-20 md:py-32 overflow-hidden text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.h2
          ...
          className="font-heading text-2xl sm:text-3xl md:text-5xl font-semibold mb-8 md:mb-10 tracking-tight leading-[1.2] text-center md:text-left bg-gradient-to-r from-white via-gray-200 to-lime-300 bg-clip-text text-transparent"
        >
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-lime-400/20 to-transparent mb-10 md:mb-12" />

        {/* Content Row */}
        <div className="flex flex-col items-center text-center lg:flex-row lg:items-center lg:justify-between lg:text-left gap-10 md:gap-12 mb-10 md:mb-12">
          ...
          <motion.div
            ...
            className="flex justify-center gap-10 sm:gap-12 md:gap-16"
          >

            {/* Email */}
            <a
              href="mailto:vanashree.ravishankar@gmail.com"
            ...
            {/* GitHub */}
            <a
              href="https://github.com/Vanashreeshankar"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/vanashree-69a303199"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2"
            >
          ...
          <motion.a
            ...
            className="text-orange-400 hover:text-orange-300 text-base md:text-lg flex items-center gap-2 hover:translate-x-1 transition-all hover:drop-shadow-[0_0_6px_#FF8A00]"
          >
            View Resume →
          </motion.a>
        ...
        {/* Divider Text */}
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-4 my-10 md:my-12 text-center">
          ...
          <div className="w-full md:flex-1 h-px bg-gradient-to-r from-transparent via-orange-400/20 to-transparent" />
        </div>
